...
namespace Infrastructure.Models
{
        ...
        where ComponentType : IGameComponent
    {
        ...
        protected virtual void OnComponentRemoved(GameComponentEventArgs<ComponentType> e)
        {
            ...
            Component2D component2D = e.GameComponent as Component2D;
            if (component2D != null)
            {
                m_2DComponents.Remove(component2D);
                component2D.DrawOrderChanged -= childDrawOrderChanged;
            }
            else
            {
                IDrawable drawable = e.GameComponent as IDrawable;
        ...
        private void insertSorted(IDrawable i_Drawable)
        {
            ...
            if (component2D != null)
            {
                ...
                m_2DComponents.Insert(idx, component2D);
            }
            else
            {
        ...
        protected override void LoadContent()
        {
            ...
            {
                component2D.SpriteBatch = m_SpriteBatch;
            }
        }
        ...
        {
            drawDrawables(i_GameTime);
            draw2DComponents(i_GameTime);
        }

        protected virtual void drawDrawables(GameTime i_GameTime)
        {
        ...
        protected virtual void draw2DComponents(GameTime i_GameTime)
        {
